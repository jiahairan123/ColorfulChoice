...
public class VarietyFragment extends BaseFragment implements XListView.IXListViewListener{
    ...
    protected void initData() {
        ...
        String url = URLValue.VIDEO_FIRST_URL + informationQuantity + URLValue.VIDEO_SECOND_URL + (informationQuantity += 5) + URLValue.VIDEO_THIRD_URL + URLValue.VIDEO_VARIETY + URLValue.VIDEO_FOURTH_URL;
        codeReuse.setAddNum(5);
