package com.example.dllo.colorfulchoice.video.variety;
...
public class VarietyFragment extends BaseFragment implements XListView.IXListViewListener{
    ...
    protected void initData() {
        ...
        String url = URLValue.VIDEO_VARIETY_FIRST_URL + informationQuantity + URLValue.VIDEO_VARIETY_SECOND_URL + (informationQuantity += 5) + URLValue.VIDEO_VARIETY_THIRD_URL;
        ...
        try {
            netTool.post(url, cookie, VideoBean.class, new NetTool.NetListener<VideoBean>() {
                ...
                public void onSuccess(VideoBean videoBean) {
                    ...
                    varietyAdapter = new VarietyAdapter(resultBeanList, getContext(), R.layout.fragment_video_child_listview);
                    Log.d("Exercise", "resultBeanList.size():" + resultBeanList.size());
                    xListView.setAdapter(varietyAdapter);
    ...
    public class VarietyAdapter extends CommonAdapter<VideoBean.ResultBean> {
        private Handler mHandler;
        private Handler handler;
        private Context context;
        private CommonViewHolder videoViewHolder = null;

        public VarietyAdapter(List<VideoBean.ResultBean> beanList, Context context, int id) {
