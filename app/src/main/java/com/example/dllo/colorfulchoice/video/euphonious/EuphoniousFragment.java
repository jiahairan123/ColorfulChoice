package com.example.dllo.colorfulchoice.video.euphonious;
...
public class EuphoniousFragment extends BaseFragment implements XListView.IXListViewListener{
    ...
    protected void initData() {
        ...
        String url = URLValue.VIDEO_FIRST_URL + informationQuantity + URLValue.VIDEO_SECOND_URL + (informationQuantity += 20) + URLValue.VIDEO_THIRD_URL + URLValue.VIDEO_EUPHONIOUS + URLValue.VIDEO_FOURTH_URL;
    ...
    public void onLoadMore() {
        String url = URLValue.VIDEO_FIRST_URL + informationQuantity + URLValue.VIDEO_SECOND_URL + (informationQuantity += 5) + URLValue.VIDEO_THIRD_URL + URLValue.VIDEO_EUPHONIOUS + URLValue.VIDEO_FOURTH_URL;
