...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        myWidth = getDefaultSize(mVideoWidth, widthMeasureSpec);
        myHeight = getDefaultSize(mVideoHeight, heightMeasureSpec);
    ...
    public void setVideoLayout(int layout, float aspectRatio) {
        ...
        /**
         * windowWidth  代表手机的宽,windowHeight   代表手机的高
         * mSurfaceHeight 和 mVideoHeight  代表视频本身的高,  mSurfaceWidth 和 mVideoWidth 代表视频本身的宽
         * mVideoAspectRatio  代表视频的宽高比
         */
